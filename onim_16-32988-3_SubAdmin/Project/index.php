...
if (isset($_POST['btn'])){
        ...
        (new App\classes\Register)->register($_POST);
...
<a href="admin-register.php" style="background:blue">Admin Register</a>
<div style="margin-left: 700px">
    <form name="myform" action="" onsubmit="return validate()" method="POST" style=" align: center;  width: 500px; height: 500px " >
        <div class="container">
            <h1>Register</h1>
