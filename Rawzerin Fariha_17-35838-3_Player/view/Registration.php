    ...
    if (!$nameErr && !$emailErr && !$passwordErr
        ...
        if (doesEmailAlreadyExist($email)){
            ...
            if ($_POST['gender'] === "Female"){
                $imgPath = "../img/female_avatar_icon.png";
            }else{
                $imgPath = "../img/male_avatar_icon.png";
            }

            if (createUser($email, $password, $name, $phone, $region, $dob, $gender, $imgPath)){
                session_start();
    ...
    <div class="content" id="reg">
        <div class="sign-in">
            ...
            <div  class="input-field-margin rounded-input-field">
                ...
                <select id="country" name="region" id="regions" class="drop-down-menu">
                    <?php
                    ...
                    ?>
                </select><br><span id="regionErr" class="error"><?php echo $regionErr ?></span>
            </div>
            <div>
            ...
            <div class="input-field-margin rounded-input-field" >
                ...
                <input id="male" type="radio" name="gender" value="Female"> Female
                <input id="female" type="radio" name="gender" value="Male"> Male<br>
            ...
            <div class="input-field-margin">
                ...
                <input id="dob" class="rounded-input-field" type="date" name="dob" value="<?php echo $dob?>" onfocus="verifyGender()" onblur="verifyDob()"><br>
